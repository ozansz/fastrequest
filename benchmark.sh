...
echo -e "\n  => Running: time python3 -c \"import fastrequest; fastrequest.get('https://www.facebook.com')\""
time python3 -c "import fastrequest; fastrequest.get('https://www.facebook.com')"
